    ...
    <div className="w-full max-w-md bg-zinc-900/80 backdrop-blur-xl border border-zinc-800/50 rounded-3xl p-8 shadow-2xl relative z-10 mt-12">
      ...
      <div className="flex bg-zinc-950/50 p-1 rounded-xl mb-8 border border-zinc-800/50 relative">
        <button
          ...
          className={`flex-1 py-2.5 text-sm font-semibold rounded-lg transition-all duration-300 z-10 ${isLoginView ? 'text-white' : 'text-zinc-500 hover:text-zinc-300'
            }`}
        >
          Log In
        </button>
        ...
        <div
          className={`absolute top-1 bottom-1 w-[calc(50%-4px)] bg-zinc-800 rounded-lg shadow-sm transition-transform duration-300 ease-out ${isLoginView ? 'translate-x-0' : 'translate-x-[calc(100%+4px)]'
            }`}
        />
      </div>
          ...
          <div className="animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-zinc-950/50 border border-zinc-800 text-white rounded-xl pl-4 pr-12 py-3 focus:outline-none focus:ring-2 focus:ring-green-500/50 focus:border-green-500/50 transition-all appearance-none cursor-pointer relative z-10"
              >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 text-zinc-500 hover:text-zinc-300 transition-colors z-20"
            >
              {showPassword ? (
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
